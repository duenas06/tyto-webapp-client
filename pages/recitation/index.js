...
export default function SignIn() {
  ...
  async function getloadData(props) {
    ...
    if (props) {
      ...
      var recitations = [];
      //GRADE SEVEN
      const GRADE_SEVEN_RECITE = query(
        collection(db, "recitation", "GRADE-SEVEN", "recitation_data"),
      ...
      //GRADE EIGHT
      const GRADE_EIGHT_RECITE = query(
        collection(db, "recitation", "GRADE-EIGHT", "recitation_data"),
        where("teacher_email", "==", props)
      );
      ...
      //GRADE NINE
      const GRADE_NINE_RECITE = query(
        collection(db, "recitation", "GRADE-NINE", "recitation_data"),
        where("teacher_email", "==", props)
      );
      ...
      //GRADE TEN
      const GRADE_TEN_RECITE = query(
        collection(db, "recitation", "GRADE-TEN", "recitation_data"),
        where("teacher_email", "==", props)
      );
  ...
  const processGiveRecitation = async (props) => {
    const giveRecits = await giveRecitation({
      ...
      recitation_id: props.recitation_id,
